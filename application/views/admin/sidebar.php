        ...
        <div class="main-header">
            ...
            <div class="logo-header" data-background-color="blue">
                ...
                <a href="<?php echo base_url('administrator') ?>" class="logo">
                    <img src="<?php echo base_url() ?>/assets/ljn.png" alt="navbar brand" class="navbar-brand">
                </a>
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    ...
                                    <li>
                                        ...
                                        ?>
                                            <a class="dropdown-item" href="<?php echo base_url('administrator/createUser'); ?>">Create User</a>
                                        <?php } ?>
                                        <div class="dropdown-divider"></div>
            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                            ...
                            <div class="collapse in" id="collapseExample">
                                <ul class="nav">
                                    ...
                                    <li>
                                        ...
                                        if ($this->session->userdata('level') == 'admin') {
                                        ?>
                                            <a class="link-collapse" href="<?php echo base_url('administrator/createUser'); ?>">
                    ...
                    <ul class="nav nav-primary">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo base_url('administrator/tagihan') ?>">
                                <i class="icon-book-open"></i>
                                <span class="sub-item">Buat Tagihan</span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a href="<?php echo base_url('administrator/ListPaket') ?>">
                                <i class="icon-speedometer"></i>
                                <span class="sub-item">List Paket</span>
                                <span class="badge badge-primary"><?php echo $pakettt ?></span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a href="<?php echo base_url('administrator/client') ?>">
                                <i class="icon-people"></i>
                                <span class="sub-item">List Client</span>
                                <span class="badge badge-success count"><?php echo $pelanggan ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url('administrator/cekPembayaran') ?>">
                                <i class="icon-people"></i>
                                <span class="sub-item">Status Pembayaran</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url('administrator/whatsapp') ?>">
                                <i class="icon-people"></i>
